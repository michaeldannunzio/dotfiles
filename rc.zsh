...
plugins=(git colored-man-pages dotnet)
...
[ -s "/opt/homebrew/opt/nvm/nvm.sh" ] && \. "/opt/homebrew/opt/nvm/nvm.sh" # This laods nvm
...
# bun completions
[ -s "/Users/michaeldannunzio/.bun/_bun" ] && source "/Users/michaeldannunzio/.bun/_bun"
